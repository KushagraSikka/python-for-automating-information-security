...
##
This is the code repository for [Python for Automating Information Security[Video]](https://www.packtpub.com/security/python-for-automating-information-security-video), originally published by [Packt](https://www.packtpub.com/?utm_source=github). It contains all the supporting project files necessary to work through the video course from start to finish. This project is actively maintained to ensure its continued relevance and functionality.
...
This repository is currently maintained by SATHVIKA KALAPALA.

Sathvika is a Data Analyst with 3+ years of professional experience across the U.S. and India, skilled in Python and SQL. She focuses on transforming raw data into automated pipelines and decision-ready dashboards.

You can connect with Sathvika via:
- LinkedIn: [Sathvika Kalapala](https://www.linkedin.com/in/sathvika-kalapala-63271512a)
